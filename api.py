...
def recommend():
    ...
    Provide a practical recommendation in 4-5 sentences.
    Cite sources (KALRO, ILRI) and include follow-up steps.
    """
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are an agricultural extension expert in Kenya."},
